...
class Book {
    ...
    static async getBookById(id) {
        const books = await this.getAllBooks(); // Await the promist to get books
        const book = books.find((book) => book.id === id); //Lambda Experssion
        return book;
    }
    ...
    static async createBook(newBookData) {
        ...
        // Replace this with your actual logic to create a book in the data source
        books.push(newBook); // Assuming in=memory array
        return newBook;
    }
    ...
    static async deleteBook(id) {
        ...
        //Replace this with your actual logic to delete the book from the data source
